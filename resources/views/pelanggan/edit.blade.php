		  ...
		  <div class="col-md-10">
		  	...
		  	<div class="row">
  				...
  				<div class="panel-heading">
					<div class="panel-title">Update Data Pelanggan</div>
				</div>
  				<div class="panel-body">

  					<form action="{{ route('pelanggan.update', ['id' => $data->id]) }}" method="POST" class="form-horizontal">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" name="harga_barang" value="{{ $data->alamat}}">
							</div>
							<div class="form-group">
